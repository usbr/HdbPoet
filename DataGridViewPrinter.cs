...
// from http://www.codeproject.com/KB/printing/datagridviewprinter.aspx
...
class DataGridViewPrinter
{
    ...
    private void Calculate(Graphics g)
    {
        if (PageNumber == 0) // Just calculate once
        {
            ...
            for (int i = 0; i < TheDataGridView.Columns.Count; i++)
            {
                ...
                tmpWidth = TheDataGridView.Columns[i].Width; //karl
                RowHeaderHeight = tmpSize.Height;
                RowHeaderHeight = TheDataGridView.ColumnHeadersHeight;
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        if (IsWithPaging)
        {
            ...
            PageStringFormat.FormatFlags =  StringFormatFlags.NoClip;
