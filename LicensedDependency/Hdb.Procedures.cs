...
namespace HdbPoet
{
    public partial class Hdb
    {
        ...
        internal void delete_from_hdb(decimal sdi, DateTime t, string interval, string timeZone)
        {
            ...
            cmd.Parameters.Add("time_zone", OracleDbType.VarChar, 3, timeZone, ParameterDirection.Input);
        ...
        void LookupApplication()
        {
            ...
            string agen_id_name = System.Configuration.ConfigurationManager.AppSettings["AGEN_ID_NAME"];
                ...
                cmd.Parameters.Add("AGEN_ID", OracleDbType.Number, ParameterDirection.Output);
                cmd.Parameters.Add("COLLECTION_SYSTEM_ID", OracleDbType.Number, ParameterDirection.Output);
                cmd.Parameters.Add("LOADING_APPLICATION_ID", OracleDbType.Number, ParameterDirection.Output);
                cmd.Parameters.Add("METHOD_ID", OracleDbType.Number, ParameterDirection.Output);
                cmd.Parameters.Add("COMPUTATION_ID", OracleDbType.Number, ParameterDirection.Output);
        ...
        */
          ...
          string validationFlag, string timeZone)
        {
            ...
            cmd.Parameters.Add("VALIDATION_FLAG", OracleDbType.VarChar, 1);
...
//            status = "";
            ...
            cmd.Parameters.Add("START_DATE_TIME", t);
            cmd.Parameters.Add("END_DATE_TIME", DBNull.Value);
            cmd.Parameters.Add("OVERWRITE_FLAG", OracleDbType.VarChar, 1);
           ...
           string timeZone) // 'V' '-' 'Z'
        {
            ...
            cmd.Parameters.Add("DO_UPDATE_Y_OR_N", OracleDbType.VarChar, 1, "Y", ParameterDirection.Input);
            cmd.Parameters.Add("DATA_FLAGS", OracleDbType.VarChar, DBNull.Value, ParameterDirection.Input);
            cmd.Parameters.Add("time_zone",OracleDbType.VarChar,3 ,timeZone, ParameterDirection.Input);
        ...
        internal bool AclReadonly(int sdi)
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("RS", OracleDbType.VarChar,10,null, ParameterDirection.ReturnValue);
